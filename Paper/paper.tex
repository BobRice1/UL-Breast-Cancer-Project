...
\begin{equation}
C_{jk} = \frac{1}{N-1} \sum_{i=1}^{N} x_{ij} x_{ik}.
\end{equation}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{pca_scree.png}
\includegraphics[width=\linewidth]{pca_variance.png}
\caption{(a) Scree plot showing the eigenvalue spectrum of the principal components. (b) Individual and cumulative variance explained as a function of the number of retained components. The first two components capture approximately $74\%$ of the total variance, increasing to $80\%$ when three components are included.}
\label{fig:variance}
\end{figure}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{pca_scatter.png}
\caption{Projection of tumour samples onto the first two principal components. Points are coloured by tumour class for visualisation only; class labels were not used during training. Partial separation is observed primarily along the first principal component.}
\label{fig:scatter}
\end{figure}
