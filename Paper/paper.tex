...
\end{equation}
where $x_{ij}$ denotes the value of feature $j$ for sample $i$ and $\bar{x}_j$ is the corresponding feature mean. Strong correlations among multiple features indicate shared morphological information and overlapping variance. The Pearson correlation analysis therefore provides both a statistical and biological basis for subsequent application of PCA.   
