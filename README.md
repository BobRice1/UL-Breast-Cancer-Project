...
The goal of this project is to build an understanding of the feature difference in malignant and benign tumours, using unsupervised learning methods. For this purpose, we use the Breast Cancer Wisconsin (Original) Data Set from the UCI Machine Learning Repository.
